 ...
 * Sa podrškom za dinamički učitane proizvode preko Load More
 *
 * @package s7design
 */
...
?>
    ...
    <script>
        // Poboljšani Quick View sa boljom podrškom za dinamički učitane proizvode
        (function($) {
            // Inicijalizacija koju možemo pozvati više puta
            window.initQuickView = function() {
                ...
                // Koristi delegiranje događaja za podršku dinamički učitanim dugmićima
                ...
                // Zatvaranje modala na klik bilo gde izvan sadržaja
                ...
                // Spreči zatvaranje modala kada se klikne na sadržaj
            ...
            $(document.body).on('post-load sw-products-loaded', function() {
                if (typeof window.initQuickView === 'function') {
                    window.initQuickView();
                }
            });

            // Reinicijalizacija nakon AJAX zahteva
            $(document).ajaxComplete(function(event, xhr, settings) {
                // Odložena inicijalizacija da se DOM potpuno učita
                setTimeout(function() {
                    if (typeof window.initQuickView === 'function') {
                        window.initQuickView();
                    }
