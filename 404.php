<?php get_header(); ?>
<div class="block-404 container">
    <div class="4">
        <h1>4</h1>
    </div>
    <!-- <h1>4<svg baseProfile="tiny" id="animationss" width="50vh" id="Layer_1" version="1.2" viewBox="0 0 512 512" width="512px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" fill="#464c53" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <div class="bb8">
    <div class="head">
      ...
      <div class="stripecontainer">
        ...
        <div class="lg1"></div>
        <div class="lg2"></div>
        <div class="odash"><div></div><div></div></div>
        <div class="odash"><div></div><div></div></div>
        <div class="dg"></div>
      </div>
      <div class="antenna">      
    ...
    <div class="body">
      <div class="ball">
        ...
        <div class="seam"></div>
        <div class="seam"></div>
        <div class="decal"><div></div><div></div></div>
        <div class="decal"><div></div><div></div></div>
        <div class="decal"><div></div><div></div></div>
        <div class="decal"><div></div><div></div></div>
      </div>
